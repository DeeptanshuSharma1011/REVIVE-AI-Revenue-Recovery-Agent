...
import { PROMPT_VERSION, REVIVE_SYSTEM_INSTRUCTION, buildRecoveryDecisionPrompt } from './prompts';

export { PROMPT_VERSION, REVIVE_SYSTEM_INSTRUCTION, buildRecoveryDecisionPrompt };
...
export class AIRecoveryDecisionService {
  ...
  private getSystemInstruction(): string {
    return REVIVE_SYSTEM_INSTRUCTION;
  }
  ...
  public async evaluateCase(
    ...
    try {
      ...
      const promptText = buildRecoveryDecisionPrompt(promptContext);
